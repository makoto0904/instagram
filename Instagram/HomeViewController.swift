...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @objc func handleButton2(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        print("DEBUG_PRINT: commentButtonボタンがタップされました。")
        ...
        let nextVC = storyboard?.instantiateViewController(identifier: "CommentViewController") as! commentViewController
        nextVC.postDataID = postDataID
